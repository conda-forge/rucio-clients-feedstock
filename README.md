...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/rucio-clients-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14312&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/rucio-clients-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `rucio-clients` can be installed with:

```
conda install rucio-clients
```

It is possible to list all of the versions of `rucio-clients` available on your platform with:
